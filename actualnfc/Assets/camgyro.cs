...
//	public Text output_text;
	...
	//	output_text.text = NFCExample.valu;
		Graph g = new Graph();
		...
		path = g.shortest_path(NFCExample.valu, Outputobject.destinationID);
		path.Reverse();
		path.Insert(0, NFCExample.valu);
	...
	void Update () {
		...
		if ( !(NFCExample.valu.Equals(Outputobject.destinationID)) ){
